...
const OrderScreen = {
  ...
  render: async () => {
    ...
    return `
    <div>
    <h1 id="order-id-header">Order ${_id}</h1>
      <div class="order">
        <div class="order-info">
          <div>
            ...
            ${
              isDelivered
                ? `<div class="success">Delivered at ${Date(deliveredAt)}</div>`
          ...
          <div>
            ...
            ${
              isPaid
                ? `<div class="success">Paid at ${Date(paidAt)}</div>`
                ...
                <li>
                 ...
                 ${
                  isPaid && !isDelivered && isAdmin
                    ? `<button id="deliver-order-button" class="fw">Deliver Order</button>`
                    : ''
                }
                </li>
        </div>
